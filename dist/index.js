...
/***/ function(module, exports, __webpack_require__) {
	...
	var _makeStore = __webpack_require__(5);
	...
	var _spriteManager = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moves = __webpack_require__(16);
	
	var _moves2 = _interopRequireDefault(_moves);
	
	var _rotates = __webpack_require__(17);
	
	var _rotates2 = _interopRequireDefault(_rotates);
	
	var _hasSprite = __webpack_require__(18);
	
	var _hasSprite2 = _interopRequireDefault(_hasSprite);
	
	var _respondsToTap = __webpack_require__(19);
	...
	exports.default = function (_ref) {
	    ...
	    var store = (0, _redux.createStore)(reducers, {
	        entity: {
	            ...
	            sinalta: {
	                hasSprite: (0, _hasSprite2.default)("sinalta", "images/sirena.png", {
	                    anchor: { x: 0.5, y: 0.1 },
	                    position: {
	                        x: config.gameDimensions.w / 2,
	                        y: config.gameDimensions.h / 2
...
/***/ function(module, exports, __webpack_require__) {
	...
	function update() {
	    ...
	    Object.keys(state.entity).forEach(function (id) {
	        ...
	        var action = (0, _actions.getByType)(respondsToTap.actionType);
	        sprite.click = function () {
	            return store.dispatch(action.apply(undefined, _toConsumableArray(respondsToTap.args)));
	        };
